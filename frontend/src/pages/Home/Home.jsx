...
const Home = () => {
  ...
  return (
    <div className='h-full overflow-x-hidden pt-20' style={{ backgroundColor: '#242424' }}>
      ...
      <div className='md:grid md:grid-cols-2' id='Home'>
        ...
        <div>
          <div>
            <h1 className='text-2xl md:text-5xl text-white font-bold flex justify-center py-5 md:pt-40 font-sans' data-aos="fade-left">FullStack Developer</h1>
          </div>
          <div>
            <h1 className='text-left py-2 px-5 md:px-40 text-white text-xl font-sans' data-aos="fade-left">Experienced full stack developer with a passion for creating web applications. Specializing in front-end design, back-end development, and database management. Freelancer committed to delivering high-quality, customized solutions for clients worldwide.</h1>
          </div>
