...
const Slider = () => {
  ...
  return (
    <div className="py-8 bg-gradient-to-r from-orange-500/5 to-red-500/5 border-y border-orange-500/20">
      <Marquee 
        direction='right' 
        speed={50}
        gradient={false}
        ...
        <div className='flex items-center space-x-16 px-8'>
          {messages.map((message, index) => (
            <div key={index} className='flex items-center space-x-4 whitespace-nowrap'>
              ...
              {/* Separator */}
              <div className='w-2 h-2 bg-orange-500 rounded-full mx-8'></div>
            </div>
          ))}
        </div>
      </Marquee>
