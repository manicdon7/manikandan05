                    ...
                    <div className='lg:col-span-2'>
                        ...
                        <div className='space-y-4'>
                            <div className='flex items-center space-x-3'>
                                ...
                                <a 
                                    href='mailto:manikandan05082003@gmail.com' 
                        ...
                        <div className='space-y-3'>
                            {quickLinks.map((link, index) => (
                                <a
                                    key={index}
                                    href={link.href}
                                    className='block text-gray-300 hover:text-orange-400 transition-colors duration-300 relative group'
                                >
                                    {link.label}
                        ...
                        <div className='flex flex-wrap gap-4'>
                            {socialLinks.map((social, index) => (
                                <a
                                    ...
                                    className='w-12 h-12 bg-white/5 hover:bg-orange-500/20 border border-white/10 hover:border-orange-500/30 rounded-lg flex items-center justify-center text-gray-400 hover:text-orange-400 transition-all duration-300 group'
                                    title={social.name}
                                >
                                    {social.icon}
                                </a>
                ...
                <div className='container mx-auto px-4'>
                    <div className='flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
                        ...
                        <div className='flex items-center space-x-6 text-sm text-gray-400'>
                            <span>Designed & Developed by <a href="https://github.com/manicdon7">Manikandan</a></span>
                        </div>
                    </div>
                </div>
            </div>
